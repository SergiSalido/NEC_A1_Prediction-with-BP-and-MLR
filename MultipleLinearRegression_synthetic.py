...
# Import dataset
dataset = pd.read_csv('data/A1-synthetic.txt', sep='\t')
#print(dataset)
...
x_training = training_patterns[['v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9']]
y_training = training_patterns['z']

x_test = test_patterns[['v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9']]
y_test = test_patterns['z']
...
for train_index, test_index in kf.split(training_patterns):
    ...
    x_training_x = x_training_cv.iloc[:, 0:9]
    x_training_y = x_training_cv.iloc[:, 9]

    X_test_x = X_test_cv.iloc[:, 0:9]
    X_test_y = X_test_cv.iloc[:, 9]
